...
if (isStarted) 
	{
		...
		{
			const int star0Xold = star0X;
			const int star0Yold = star0Y;

			star0X = ClampScreenX(star0X, starwidth);
			if (star0X != star0Xold)
			{
				star0vx = -star0vx;
			}
			star0Y = ClampScreenY(star0Y, starheight);
			if (star0Y != star0Yold)
			{
				star0vy = -star0vy;
			}
		...
		{
			const int star1Xold = star1X;
			const int star1Yold = star1Y;

			star1X = ClampScreenX(star1X, starwidth);
			if (star1X != star1Xold)
			{
				star1vx = -star1vx;
			}
			star1Y = ClampScreenY(star1Y, starheight);
			if (star1Y != star1Yold)
			{
				star1vy = -star1vy;
			}
		...
		{
			const int star2Xold = star2X;
			const int star2Yold = star2Y;

			star2X = ClampScreenX(star2X,starwidth);
			if (star2X != star2Xold)
			{
				star2vx = -star2vx;
			}
			star2Y = ClampScreenY(star2Y,starheight);
			if (star2Y != star2Yold)
			{
				star2vy = -star2vy;
			}
		...
		if (IsColliding(dudeX, dudeY, dudeWidth, dudeHeight, star0X, star0Y, starwidth, starheight)) {
			star0IsEaten = true;
		}
		if (IsColliding(dudeX, dudeY, dudeWidth, dudeHeight, star1X, star1Y, starwidth, starheight)) {
			star1IsEaten = true;
		}
		if (IsColliding(dudeX, dudeY, dudeWidth, dudeHeight, star2X, star2Y, starwidth, starheight)) {
			star2IsEaten = true;
		}
...
void Game::DrawStar(int x, int y) {
...
{
	if (star0IsEaten && star1IsEaten && star2IsEaten) {
		GameOver(x, y);
	...
	if (!star0IsEaten) {
		DrawStar(star0X, star0Y);
	}
	if (!star1IsEaten) {
		DrawStar(star1X, star1Y);
	}
	if (!star2IsEaten) {
		DrawStar(star2X, star2Y);
	}
